...
hvg_obj=FindVariableFeatures(object=seur_obj,nfeatures=8000)
hvg_genes=hvg_obj@assays$originalexp@var.features
...
df <- as.data.frame(do.call(cbind, d[[gene_dict_orig]][['ratio_overlapping_genes']]))
```
